...
public class DialogueEvents
{
    ...
    //{
    //    //EventsManager.Instance.uiManager.GetComponent<UiManager>().CallDialogueUI(knotName);
    //    //DialogueManager.Instance.GetComponent<DialogueManager>().CallDialogue(knotName);
